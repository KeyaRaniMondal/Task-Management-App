          ...
          child: Column(
            ...
            children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        const Text(
                          ...
                          style: TextStyle(
                              fontSize: 14, color: MyThemeColors.textColor),
                        ),
                      ],
                    ),
                ...
                children: [
                  if (isSound == true)
                    Icon(Icons.volume_up_outlined,
                        size: 25, color: MyThemeColors.textColor)
                  else
                  ...
                  const Text(
                    "Sounds",
                    style:
                        TextStyle(fontSize: 18, color:MyThemeColors.textColor),
                  ),
                  Expanded(child: Container()),
                  CupertinoSwitch(
                      value: isSound,
                ...
                child: Row(
                  children: [
                    ...
                    const Text(
                      "Privacy & Security",
                      style: TextStyle(
                          fontSize: 18, color:MyThemeColors.textColor),
                    ),
                    Expanded(child: Container()),
                    const Icon(
                      Icons.arrow_forward_ios,
              ...
              GestureDetector(
                ...
                child: const Text(
                  "Sign Out",
                  style: TextStyle(fontSize: 17, color: MyThemeColors.textColor),
                ),
              ),
              SizedBox(
                height: he * 0.02,
